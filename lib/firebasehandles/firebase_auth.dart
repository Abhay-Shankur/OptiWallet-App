...
class FirebaseAuthOperations {
      ...
      if(credatedDid.containsKey('metaData')) {
        ...
        if(metaData.containsKey('didDocument')){
          Map<String,dynamic> didDocument = {
            ...
            "verificationMethodId": metaData['didDocument']['verificationMethod'][0]['id'] as String
          };
          debugPrint('Registering DID..........');
          Map<String,dynamic> responseDocument = await apiService.postRegisterDid(didDocument);
          // Obtain shared preferences.
          final SharedPreferences prefs = await SharedPreferences.getInstance();
          prefs.setString('did', responseDocument['did'] as String);
          ...
          debugPrint('Storing DID into FireStore.........');
          FirestoreHandler firestoreHandler = FirestoreHandler();
          if(await firestoreHandler.setDocument('DID', responseDocument['did'] as String, responseDocument['metaData']['didDocument']) &&
  ...
  Future<void> signOut() async {
    try {
      ...
      FirestoreHandler firestoreHandler = FirestoreHandler();
      firestoreHandler.updateDocument('USER', _auth.currentUser?.email as String,{'token':null});
      firestoreHandler.closeFirestore();
